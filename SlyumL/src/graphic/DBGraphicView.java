...
public class DBGraphicView extends GraphicComponent implements MouseMotionListener, MouseListener, IClassComponentsObserver, Printable, KeyListener, MouseWheelListener
{
	...
	public static void setGridSize(int size)
	{
		...
		for (DBGraphicView gv : PanelClassDiagram.getInstance().getAllGraphicView())
	 ...
	 */
	public DBGraphicView(ClassDiagram classDiagram)
	{
		super();
