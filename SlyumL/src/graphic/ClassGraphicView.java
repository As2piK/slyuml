...
public class ClassGraphicView extends GraphicComponent implements MouseMotionListener, MouseListener, IClassComponentsObserver, Printable, KeyListener, MouseWheelListener
{
	...
	public static void setGridSize(int size)
	{
		...
		for (ClassGraphicView gv : PanelClassDiagram.getInstance().getAllGraphicView())
	 ...
	 */
	public ClassGraphicView(ClassDiagram classDiagram)
	{
		super();
	 ...
	 */
	public boolean addEntity(ClassEntityView component)
	{
	 ...
	 */
	public ClassEntityView getEntityAtPosition(Point pos)
	{
	 ...
	 */
	public LinkedList<ClassEntityView> getSelectedEntities()
	{
		final LinkedList<ClassEntityView> selectedEntities = new LinkedList<ClassEntityView>();
