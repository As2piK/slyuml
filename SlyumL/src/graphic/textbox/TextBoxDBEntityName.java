 ...
 */
public class TextBoxDBEntityName extends TextBox
{
	 ...
	 *            the entity
	 */
	public TextBoxDBEntityName(ClassGraphicView parent, Entity entity)
	{
	...
	{
		return Utility.truncate(g2, text, tableWidth);
	}
}
