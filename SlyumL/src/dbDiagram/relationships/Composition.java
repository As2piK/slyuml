...
/**
 * Represent a composition in UML structure.
 * 
 * @author David Miserez
 * @version 1.0 - 24.07.2011
 */
public class Composition extends Binary
{
	/**
	 * Create a new composition between the entity source and target. Two news
	...
	{
		return swing.XMLParser.Aggregation.COMPOSE.toString();
	}
}
