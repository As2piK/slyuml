...
public abstract class ClassEntityView extends MovableComponent implements Observer
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if (Slyum.ACTION_TEXTBOX_UP.equals(e.getActionCommand()) || Slyum.ACTION_TEXTBOX_DOWN.equals(e.getActionCommand()))
		{
			...
			{
				final Attribute attribute = (Attribute) ((TextBoxAttribute) pressedTextBox).getAssociedComponent();
	...
	{
		final Method method = new Method("method", PrimitiveType.VOID_TYPE, Visibility.PUBLIC, component);
