...
public class PanelDBDiagram extends JPanel
{
	private static PanelDBDiagram instance = new PanelDBDiagram();

	public static PanelDBDiagram getInstance()
	{
		return instance;
	}
	...
	private PanelDBDiagram()
	{
		...
		leftPanel.add(new HierarchicalDBView(getDBDiagram()));
