...
public class DependencyView extends RelationView
{
	...
	{
		if (!(newCompo instanceof ClassEntityView))
			return false;

		if (oldCompo.equals(getFirstPoint().getAssociedComponentView()))
			setSource((ClassEntityView) newCompo);
		else
			setTarget((ClassEntityView) newCompo);
	 ...
	 */
	public void setSource(ClassEntityView source)
	{
	 ...
	 */
	public void setTarget(ClassEntityView target)
	{
