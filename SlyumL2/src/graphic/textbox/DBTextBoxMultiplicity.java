...
import dbDiagram.relationships.Multiplicity;
 ...
 */
public class DBTextBoxMultiplicity extends TextBoxLabel
{
	/**
	 ...
	 */
	public DBTextBoxMultiplicity(GraphicView parent, Multiplicity multiplicity, MagneticGrip grip)
	{
