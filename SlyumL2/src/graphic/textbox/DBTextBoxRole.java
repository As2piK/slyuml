 ...
 */
public class DBTextBoxRole extends TextBoxLabel
{
	/**
	...
	private DBTextBoxMultiplicity tbm;
	 ...
	 */
	public DBTextBoxRole(GraphicView parent, Role role, MagneticGrip grip)
	{
		...
		parent.addOthersComponents(tbm = new DBTextBoxMultiplicity(parent, role.getMultiplicity(), grip));
	}
	...
	public DBTextBoxMultiplicity getTextBoxMultiplicity()
	{
		return tbm;
	}
